...
def forecast_sales(historical_data: pd.DataFrame, predict_day: int) -> DataFrame:
    ...
    If there is no data for a specific region/product combination, the amount is set to None.
    If a prediction method like linear regression fails, the amount is set to None.
    """
    # EVOLVE-BLOCK-START
