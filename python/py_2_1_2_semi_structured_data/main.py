...
df_adults = pd.DataFrame({
    "user_id":   pd.Series([0, 1, 2, 3, 3, None], dtype="Int64"),  # <-- 0 and None are not allowed
    "age":       [22, "sixteen", 25.4, 34, 150, 67],  # <-- "sixteen" is not a number, 150 is outside our allowed age range
    "height_cm": [100, 170.4, 160.4, 75.12, 310, 172],  # <-- 310 is outside our allowed height range and "172" is a string
