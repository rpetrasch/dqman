...
import { DqIntegrationService } from '../../services/dq-integration.service';
import { DqRuleService } from '../../services/dq-rule.service';
import { DqIntegration } from '../../models/dq-integration.model';
...
export class FlowStepDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private integrationService: DqIntegrationService,
    ...
    if (data) {
      ...
      // Extract integrationId and ruleId from the step's integration/rule objects
      if ((data as any).integration) {
